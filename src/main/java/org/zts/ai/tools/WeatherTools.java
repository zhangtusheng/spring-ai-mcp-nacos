...
import org.zts.ai.annotation.ToolsMark;
...
public class WeatherTools{
    ...
    public String getWeatherForecastByLocation(double latitude, double longitude) {
        ...
        System.out.println("process data is : " + weatherData);
        ...
        System.out.println("process data response is : " + weatherInfo.toString());
